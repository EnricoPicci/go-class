...
func (u *user) readLikes() int {
	...
	// Since we use a syncRWMutes, the total duration of the execution of all reads will be approximatively equal to the the delay added to the read
	// since the read operations will be performed in parallel.
